...
**Then immediately load `adk-dev-guide.md`** — it contains the development workflow, coding guidelines, and operational rules you must follow when implementing the agent.
