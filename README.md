...
`docs/dashboard.html` is the live rendering of everything described here — it
...
`docs/dashboard.html`, regenerated by `uv run telemetry`. Each tab answers one
...
├── queue.md                     # Local-only cross-repo pointer set — does NOT survive clone
