...
def test_friction_label_count_stored(tmp_path: Path) -> None:
    from tests.telemetry.jsonl_helpers import _assistant, _user, _write_jsonl
...
def test_agent_spawns_stored_as_json(tmp_path: Path) -> None:
    from tests.telemetry.jsonl_helpers import (
...
def test_jsonl_adapter_stores_bash_antipatterns_from_parser(tmp_path: Path) -> None:
    ...
    from tests.telemetry.jsonl_helpers import _assistant_with_tools, _user, _write_jsonl
